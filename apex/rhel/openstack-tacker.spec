...
#remove a debian specifc init script
rm -f %{buildroot}/etc/init.d/tacker-server

install -p -D -m 644 openstack-tacker.service %{buildroot}%{_unitdir}/openstack-tacker.service
